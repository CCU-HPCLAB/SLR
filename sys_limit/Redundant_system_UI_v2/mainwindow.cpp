...
MainWindow::MainWindow()
{
    ...
    setWindowTitle("Memory monitoring");
    ...
    connect(test,SIGNAL(clicked()),this,SLOT(testprogram()));
    connect(exit,SIGNAL(clicked()),this,SLOT(close()));

    btnlayout->addStretch();
    btnlayout->addWidget(start);
    btnlayout->addWidget(test);
...
void MainWindow::createFormGroupBox()
{
    ...
    QLabel *ip1 =new QLabel(tr("LevelA:"));
    ...
    QLabel *ip2 =new QLabel(tr("LevelC:"));
    ...
    QLabel *ip3 =new QLabel(tr("LevelB:"));
    ...
    count->setValidator(posintegerValidator);
    ...
    layout->addRow(ip3,LineEdit4);
    //layout->addRow(hbox2);
    layout->addRow(ip2,LineEdit5);
    layout->addRow(hbox3);
    layout->addRow(new QLabel(tr("Number of tests:")),count);
...
void MainWindow::testprogram(){
    QString k="echo "" ";
    QString s=">/home/pi/level.log";
    QString w;
    w =k+s;
    system(qPrintable(w));
    if(1)
    {
        QString k="echo ";
        QString s=" > /home/pi/sysy_limt/parameter";
        QString w;
        w =k+count->text()+s;
        system(qPrintable(w));
    }
    for(int i=0 ;i<=2;i++)
    {
        ...
        else if(i==1)
        {
            ...
            QString s=" >> /home/pi/level.log";
            QString w;
            w =k+LineEdit5->text()+s;
            system(qPrintable(w));
        }
    }
   system("/home/pi/sysy_limt/autostart.sh");
}
